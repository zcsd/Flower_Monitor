...
class MqttClient:
    ...
    def on_publish(self, client, userdata, mid):
        print("Pub env reading at", datetime.now().strftime("%Y-%m-%d %H:%M:%S"))

    def pub_env_readings(self, data):
        self.client.publish("flower/env_sensor", payload=json.dumps(data), qos=0, retain=True)
